...
import random
from Capitals_List_v2 import capitals  # Importing the list of capitals from Capitals_List_v2
...
class Quiz:
    ...
    def help(self):
        get_help = Help(self)
        get_help.help_text.configure(text="Text Here")  # Help text can be configured
...
class Help:
    def __init__(self, partner):
        ...
        # Creating the frame for the help section
