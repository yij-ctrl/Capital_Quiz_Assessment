...
class Quiz:
    ...
    def history(self):
        ...
        get_history.history_text.configure(text="This section displays your history for the quiz. If you would like to "
                                                "save your results, please export the history by clicking the history "
                                                "button")
...
class History:
    def __init__(self, partner):
        ...
        # Formatting the dismiss button (this functions as it has a command)
