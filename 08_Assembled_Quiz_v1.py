...
class History:
    def __init__(self, partner):
        ...
        self.export_button = Button(self.dismiss_export_frame, text="Export", font="Arial 12 bold")
...
class Help:
    def __init__(self, partner):
        ...
        # Creating and formatting a label for the heading of the help frame
        ...
        # Creating and formatting a button that 'deletes' the help frame
