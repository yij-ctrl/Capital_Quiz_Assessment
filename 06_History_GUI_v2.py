...
This version has changed 'history' to 'History' and the export and dismiss buttons are in the same column (instead of
the same row).
Jung Woo Yi
...
class Quiz:
    def __init__(self):
        background_colour = "red"  # Colour formatting
